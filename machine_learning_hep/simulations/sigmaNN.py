...
from ROOT import TCanvas, TH1F, TFile, gROOT, TLatex, gPad  # pylint: disable=import-error,no-name-in-module
...
npartrun5 = [11.1, 24.3, 24.2, 42, 71.2, 113.7] #KRIPTON VALUE 50, IS APPROX
...
gPad.SetLogx()
gsigmaNN = TGraphErrors(npoints, energy_, sigmann_, errorenergy_, errorsigmann_);
gsigmaNN.SetTitle(";energy(TeV);#sigma^{inel}_{NN} (mb);");
gsigmaNN.GetXaxis().SetTitleOffset(1.2)
gsigmaNN.Draw("ALP")
...
#fpbpb05 = TF1("f2", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x", -1, 5.);
