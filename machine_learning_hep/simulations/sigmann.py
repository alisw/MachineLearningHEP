...
print("dndeta at -4<eta<4, val =%.2f" % fpbpb05_norm.Integral(dndeta_points_min, dndeta_points_max))
fpbpb05_norm.Write()

listdndetafitrun5 = []
for i, species in enumerate(speciesrun5):
    listdndetafitrun5.append(fpbpb05.Clone("dndeta_fit_%s" % species))
    scalefactor = npartrun5[i] * 0.5 * dndetaperpairrun5[i] / listdndetafitrun5[i].Eval(0.0)
    listdndetafitrun5[i].FixParameter(0, listdndetafitrun5[i].GetParameter(0) * scalefactor)
    listdndetafitrun5[i].FixParameter(1, listdndetafitrun5[i].GetParameter(1) * scalefactor)
    listdndetafitrun5[i].FixParameter(2, listdndetafitrun5[i].GetParameter(2) * scalefactor)
    listdndetafitrun5[i].FixParameter(3, listdndetafitrun5[i].GetParameter(3) * scalefactor)
    listdndetafitrun5[i].FixParameter(6, listdndetafitrun5[i].GetParameter(6) * scalefactor)
    ...
    print("dndeta at -4<eta<4, val =%.2f" % listdndetafitrun5[i].Integral(dndeta_points_min, dndeta_points_max))

c3 = TCanvas("c3", "A Simple Graph with error bars", 200, 10, 700, 500)
gPad.SetLogy()
graphpbpb05_sym.Draw("ALP")
graphpbpb05_sym.SetMinimum(10.0)
graphpbpb05_sym.SetMaximum(50000.0)
