...
##
python do_entire_analysis.py -a jet_FF -r submission/default_analyzer_ef.yml -d data/data_prod_20200824/database_ml_parameters_LcpK0spp_0824_jet_2_6_ef.yml -c
python do_entire_analysis.py -a jet_FF -r submission/default_analyzer_ef.yml -d data/data_prod_20200824/database_ml_parameters_LcpK0spp_0824_jet_6_12_ef.yml -c
#             
pkill -9 -u talazare do_entire_analysis
##################################################################################################################################################
#
...
#
python do_entire_analysis.py -a jet_r_shape -r submission/default_analyzer_ef.yml -d data/data_prod_20200824/database_ml_parameters_D0pp_0824_2_6_ef.yml -c
python do_entire_analysis.py -a jet_r_shape -r submission/default_analyzer_ef.yml -d data/data_prod_20200824/database_ml_parameters_D0pp_0824_6_12_ef.yml -c
