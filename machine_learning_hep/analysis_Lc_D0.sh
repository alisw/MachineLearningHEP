...
#
nice python do_entire_analysis.py -a jet_FF -r submission/default_feeddown.yml -d data/data_prod_20200824/database_ml_parameters_LcpK0spp_0824_jet.yml -c
#
#mkdir /data/Derived_testResults/Jets/Lc/2_6
#mkdir /data/Derived_testResults/Jets/Lc/6_12
#
...
nice python do_entire_analysis.py -a jet_r_shape -r submission/default_feeddown.yml -d data/data_prod_20200824/database_ml_parameters_D0pp_0824.yml -c
#
#mkdir /data/Derived_testResults/Jets/D0kAnywithJets/2_6
#mkdir /data/Derived_testResults/Jets/D0kAnywithJets/6_12
#
