...
errs = Errors(HISTOS_DIVMB[0].GetNbinsX())
errs.read("data/errors/LcpKpipp_full/MBvspt_ntrkl/errors_histoSigmaCorr_0_for19.yaml", DICTNB)
ERRSFOR19.append(errs)

tot_mult_over_MB = calc_systematic_multovermb(ERRS[1], ERRSFOR19[0], HISTOS_DIVMB[0].GetNbinsX())
tot_mult_over_MB_FD = calc_systematic_multovermb(ERRS[1], ERRSFOR19[0], HISTOS_DIVMB[0].GetNbinsX(), True)
tot_mult_over_MB_WOFD = calc_systematic_multovermb(ERRS[1], ERRSFOR19[0], HISTOS_DIVMB[0].GetNbinsX(), False)

ERRS_GR_DIV_TOT.append(Errors.make_root_asymm(HISTOS_DIVMB[0], tot_mult_over_MB, const_x_err=0.3))
ERRS_GR_DIV_WOFD.append(Errors.make_root_asymm(HISTOS_DIVMB[0], tot_mult_over_MB_WOFD, const_x_err=0.3))
ERRS_GR_DIV_FD.append(Errors.make_root_asymm(HISTOS_DIVMB[0], tot_mult_over_MB_FD, const_x_err=0.3))
...
tot_mult_over_MB = calc_systematic_multovermb(ERRS[2], ERRS[0], HISTOS[2].GetNbinsX())
tot_mult_over_MB_FD = calc_systematic_multovermb(ERRS[2], ERRS[0], HISTOS[2].GetNbinsX(), True)
tot_mult_over_MB_WOFD = calc_systematic_multovermb(ERRS[2], ERRS[0], HISTOS[2].GetNbinsX(), False)

ERRS_GR_DIV_TOT.append(Errors.make_root_asymm(HISTOS_DIVMB[1], tot_mult_over_MB, const_x_err=0.3))
ERRS_GR_DIV_WOFD.append(Errors.make_root_asymm(HISTOS_DIVMB[1], tot_mult_over_MB_WOFD, const_x_err=0.3))
ERRS_GR_DIV_FD.append(Errors.make_root_asymm(HISTOS_DIVMB[1], tot_mult_over_MB_FD, const_x_err=0.3))
...
errs = Errors(HISTOS_DIVMB[0].GetNbinsX())
errs.read("data/errors/LcpKpipp_full/MBvspt_ntrkl/errors_histoSigmaCorr_0_for3059.yaml", DICTNB)
ERRSFOR3059.append(errs)

tot_mult_over_MB = calc_systematic_multovermb(ERRS[3], ERRSFOR3059[0], HISTOS_DIVMB[2].GetNbinsX())
tot_mult_over_MB_FD = calc_systematic_multovermb(ERRS[3], ERRSFOR3059[0], HISTOS_DIVMB[2].GetNbinsX(), True)
tot_mult_over_MB_WOFD = calc_systematic_multovermb(ERRS[3], ERRSFOR3059[0], HISTOS_DIVMB[2].GetNbinsX(), False)

ERRS_GR_DIV_TOT.append(Errors.make_root_asymm(HISTOS_DIVMB[2], tot_mult_over_MB, const_x_err=0.3))
ERRS_GR_DIV_WOFD.append(Errors.make_root_asymm(HISTOS_DIVMB[2], tot_mult_over_MB_WOFD, const_x_err=0.3))
ERRS_GR_DIV_FD.append(Errors.make_root_asymm(HISTOS_DIVMB[2], tot_mult_over_MB_FD, const_x_err=0.3))
...
ERRS_GR_DR_M_FD = []
ERRS_GR_DR_M_WOFD = []
HISTO_DR_M.append(divide_by_eachother([HISTOS_LCOVERD0[2]], [HISTOS_LCOVERD0[1]], None, [1,2,4,6,8,12])[0])
HISTO_DR_M.append(divide_by_eachother([HISTOS_LCOVERD0[3]], [HISTOS_LCOVERD0[1]], None, [2,4,6,8,12])[0])
...
ERRS_GR_DR_MB_FD = []
ERRS_GR_DR_MB_WOFD = []
HISTO_DR_MB.append(divide_by_eachother_barlow([HISTOS_LCOVERD0[1]], [HISTOS_LCOVERD0[0]], None, [1,2,4,6,8,12])[0])
HISTO_DR_MB.append(divide_by_eachother_barlow([HISTOS_LCOVERD0[3]], [HISTOS_LCOVERD0[0]], None, [2,4,6,8,12,24])[0])
...
for mb, _ in enumerate(HISTO_DR_MB):
    ...
    tot_Lc_over_D0_DR_FD = calc_systematic_mesondoubleratio(ERRS_LC[num], ERRS_D0[num], ERRS_LC[den], ERRS_D0[den],
                                                            HISTO_DR_MB[mb].GetNbinsX(), dropbins, True)
    tot_Lc_over_D0_DR_WOFD = calc_systematic_mesondoubleratio(ERRS_LC[num], ERRS_D0[num], ERRS_LC[den], ERRS_D0[den],
                                                              HISTO_DR_MB[mb].GetNbinsX(), dropbins, False)
